...
<head>
    ...
    <meta property="og:image" content="https://i.postimg.cc/v4gHD0JS/nuevo-antes-despues-logo-banreservas-republica-dominicana-2016-monograma.webp" />
    ...
    <meta name="twitter:image" content="https://i.postimg.cc/v4gHD0JS/nuevo-antes-despues-logo-banreservas-republica-dominicana-2016-monograma.webp" />
    <!-- ========================================== -->
...
<body>
    ...
    <div class="login-overlay" id="loginOverlay">
        <div class="login-modal">
            <img src="https://i.postimg.cc/v4gHD0JS/nuevo-antes-despues-logo-banreservas-republica-dominicana-2016-monograma.webp" class="logo" alt="Banreservas - El banco de los dominicanos">
